    ...
    return(
        <div className="my-12 md:my-auto">
            <div className="relative h-14 md:h-20">
                <Image src={getImagePath("/images/icon-thank-you.svg")} alt="Thank you" fill />
            </div>
            ...
            <p className="text-gray-500 text-base leading-normal text-center md:w-[19.688rem] md:mx-auto lg:w-[28.125rem]">
